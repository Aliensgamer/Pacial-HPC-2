...
theta = pd.read_csv('/content/VectorTheta.txt', header=None)
theta

"""Esta seria el vector de coeficientes que hacen converger en las diferentes iteraciones a la funcion de costo
